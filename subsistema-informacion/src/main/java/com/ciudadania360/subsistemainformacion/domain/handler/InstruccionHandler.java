...
public class InstruccionHandler {
    private final InstruccionRepository repo;
    public InstruccionHandler(InstruccionRepository repo) { this.repo = repo; }
    ...
    public Instruccion create(Instruccion e) { return repo.save(e); }
