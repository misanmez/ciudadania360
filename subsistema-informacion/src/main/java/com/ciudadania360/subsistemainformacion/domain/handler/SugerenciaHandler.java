...
import com.ciudadania360.subsistemainformacion.domain.repository.SugerenciaRepository;
...
public class SugerenciaHandler {
    ...
    public SugerenciaHandler(SugerenciaRepository repo) { this.repo = repo; }
    ...
    public Sugerencia create(Sugerencia e) { return repo.save(e); }
