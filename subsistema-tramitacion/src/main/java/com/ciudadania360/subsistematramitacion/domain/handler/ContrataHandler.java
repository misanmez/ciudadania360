...
public class ContrataHandler {
    private final ContrataRepositorio repo;
    public ContrataHandler(ContrataRepositorio repo) { this.repo = repo; }
    ...
    public Contrata create(Contrata e) { if(e.getId()==null) e.setId(UUID.randomUUID()); return repo.save(e); }
