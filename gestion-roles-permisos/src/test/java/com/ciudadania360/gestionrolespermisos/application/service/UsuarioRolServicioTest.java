...
class UsuarioRolServicioTest {
    ...
    @InjectMocks
    private UsuarioRolServicio svc;
    ...
    void listDelegatesToHandler() {
        ...
        List<UsuarioRol> result = svc.list();
    ...
    void getDelegatesToHandler() {
        ...
        UsuarioRol result = svc.get(e.getId());
    ...
    void createDelegatesToHandler() {
        ...
        UsuarioRol result = svc.create(e);
    ...
    void updateDelegatesToHandler() {
        ...
        UsuarioRol result = svc.update(e.getId(), e);
