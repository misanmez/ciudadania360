...
import com.ciudadania360.subsistemavideoconferencia.domain.repository.CitaVideollamadaRepository;
import org.springframework.stereotype.Component;
import java.util.*;

@Component
public class CitaVideollamadaHandler {
    private final CitaVideollamadaRepository repo;
    public CitaVideollamadaHandler(CitaVideollamadaRepository repo) { this.repo = repo; }
    ...
    public CitaVideollamada create(CitaVideollamada e) { return repo.save(e); }
